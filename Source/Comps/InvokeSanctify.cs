...
namespace ReviaRace.Comps
{
    public abstract class InvokeSanctify : CompUseEffect
    {
        ...
        public override AcceptanceReport CanBeUsedBy(Pawn p)
        {
            ...
            {
                return new AcceptanceReport(Strings.SanctifyNonMeleeWeapon.Translate());
            }
            ...
            {
                return new AcceptanceReport(Strings.SanctifyAlreadySanctified.Translate());
            }

            else if (!p.IsRevia() && !p.IsSkarnite())
            {
                return new AcceptanceReport(Strings.SanctifyNonReviaNonSkarnite.Translate());
            }
